...
export class CreateSolicitudEspecificacionTecnicaDto {
  ...
  @ApiProperty({ isArray: true, type: [CreateEspecificacionTecnicaDetalleDto] })
  @Type(() => CreateEspecificacionTecnicaDetalleDto)
  @ArrayMinSize(1)
  @ValidateNested({ each: true })
  readonly caracteristicas: CreateEspecificacionTecnicaDetalleDto[];
}
